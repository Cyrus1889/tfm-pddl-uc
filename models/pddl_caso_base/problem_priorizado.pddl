(define (problem despacho_24h)
    ...
    (:init
        ...
        (= (costo_total) 0)
        (= (costo_pv) 5)          ; Costo bajo
        (= (costo_hidro) 10)      ; Costo medio
        (= (costo_termica) 90)    ; Costo alto
        (= (unidad_despacho) 10)  ; Despachamos en bloques de 10 MWh
        ...
        ; Capacidad Hidroeléctrica por Hora
    ...
    (:goal
        ;; El objetivo es simplemente llegar a la última hora.
        ;; Las precondiciones de "avanzar_hora" aseguran que la demanda se cubra en el camino.
        (hora_actual h23)
    )
